...
<p><img align="right" src="https://github.com/Adam-pw/Adam-pw/blob/main/assets/animation_500_kxa883sd.gif" alt="shaffee-pw" /></p>

## 📋 Responsibilities

- 🔧 Develop and maintain data pipelines to ensure the availability of clean and reliable data.
- 🤝 Collaborate with stakeholders to understand business requirements and translate them into technical solutions.
- ⚡ Optimize SQL queries and data transformations for performance and efficiency.
- 🗂️ Build and manage data models to support analytics and reporting needs.
...
- **Technical Skills:**
  - 🛠️ Proficient in SQL for data manipulation and querying.
  - 🖇️ Experience with data transformation tools like dbt or similar.
  - 🐍 Knowledge of Python or other programming languages for scripting and automation.
  - ☁️ Familiarity with cloud platforms (e.g., AWS, Azure, GCP) and data storage solutions.
  - 📊 Understanding of data modeling principles (e.g., Kimball, Data Vault).
  - 📊 Expertise in visualization tools like Power BI, Tableau, and Looker.
- **Analytical Skills:**
